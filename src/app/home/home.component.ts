...
export class HomeComponent {
  menuItems = [
    { icon: '👤', title: '社員管理', desc: '社員一覧、検索、詳細閲覧・編集', btn: '社員一覧', link: '/employee-list' },
    { icon: '💴', title: '給与管理', desc: '社員の給与情報の登録・編集・履歴管理', btn: '給与管理', link: '/salary-management' },
    { icon: '🧮', title: '保険料計算', desc: '社員ごとの保険料を自動算出・表示', btn: '保険料計算', link: '/employee-premium-calc' },
